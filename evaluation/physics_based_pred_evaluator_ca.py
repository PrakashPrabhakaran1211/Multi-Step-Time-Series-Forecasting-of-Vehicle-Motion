...
class physicsBasedEvaluationCa:
    def __init__(self):
        self.worksheet = None
    ...
    def get_ground_truth(self):
        ...
        for frame_idx in range(0, self.frame_range, self.frames_skipped):
            ...
            for track_id_idx in track_ids:
                ...
                self.ground_truth.append(self.x_center + self.y_center )
    ...
    def create_evaluation_workbook(self):
        ...
        self.worksheet.write(0, 3 + 2 * self.pred_horizon, 'xCenterGroundTruth')
        self.worksheet.write(0, 3 + 3 * self.pred_horizon, 'yCenterGroundTruth')
